package com.cinsec.dmc.base.dao;
 ...
 * Created by MyElipse
 * 
 * @author huangweijin Date: 2011-3-22 Time: 10:47:54 Declare：Dao基类
 */
public interface IBaseAppDao<T extends Object, PK extends Serializable> {
     ...
     * @throws SQLException
     */
    List<T> getResultList(String jql, Map<String, Object> parVals) throws SQLException;
     ...
     * @throws SQLException
     */
    T getSingleResult(String jql, Map<String, Object> parVals) throws SQLException;
     ...
     * @throws SQLException
     */
    Boolean isEntityExist(String jql, Map<String, Object> parVals) throws SQLException;
