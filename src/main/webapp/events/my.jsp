...
<p id="description">
	Below you can find the events for <strong><c:out
			value="${currentUser.email}" /></strong>. Once security is applied this will
	be the events for the currently logged in user.
</p>
