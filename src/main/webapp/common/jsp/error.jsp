...
<body>
	<form id="errorFrm" method="post">
		<img
			src="${_sysApplication_.goToUrl}/common/images/404b_${_amwayCss_}.jpg"
			width="100%" />
		<div align="right">
			<div>
				<a onclick="setStackVi();"
					style="text-decoration: underline; cursor: pointer">异常信息</a>： <font
					color="red" size="4"> <span id="exceptionName"><s:property
		...
		<div style="width: 100%;">
			<div align="right"></div>
			<div id="stackInfo"
				style="height: 230px; overflow: auto; visibility: hidden">
				<s:property value="%{exceptionStack}" />
			</div>
			<div align="right" style="margin-top: 5px; margin-right: 30px">
				<a href="javascript:history.back(-1);"> <img
					src="${_sysApplication_.goToUrl}/common/images/404_btm.jpg" />
				</a> &nbsp;&nbsp; <a href="${pageContext.request.contextPath}"
					target="_parent"> <img
					src="${_sysApplication_.goToUrl}/common/images/404_btm2.jpg" />
				</a> &nbsp;&nbsp; <img
					src="${_sysApplication_.goToUrl}/common/images/404_btm3.jpg"
					onclick="sendEmail(this,'<%=basePath %>/exceptionCfgAction!send.action');"
