...
(function($) {
	...
	/*
	 * jquery.fn.jEditAction = function(options){ return this.each(function(){
	 * var thisHref= $(this).attr('href'); $(this).bind('click', function(e) {
	 * e.preventDefault(); $.getJSON(thisHref,function(data){ data. }); }); });
	 * 
	 *  };
	 */
